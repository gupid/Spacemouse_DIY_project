...
static const uint8_t devInfoModelNumber[] = "SpaceMouse DIY";
...
static const uint8_t devInfoMfrName[] = "DIY by Trilogic";
...
{
  0x02,       // Vendor ID Source: 0x02代表这个ID是从USB Implementer's Forum分配的
  LO_UINT16(0x256f), HI_UINT16(0x256f), // Vendor ID: 0x256f (SpaceMouse Pro Wireless)
  LO_UINT16(0xc632), HI_UINT16(0xc632), // Product ID: 0xc632 (SpaceMouse Pro Wireless)
  LO_UINT16(0x0100), HI_UINT16(0x0100)  // Product Version: v1.0.0 (您可以自定义)
};
